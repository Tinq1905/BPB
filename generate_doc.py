...
def generate_pg(tt,pg):
    ...
    tt = tt[0].strip().replace('%','\%').replace('&','\&').replace('$','\$').replace('\r\n','\\newline ')
    pg = pg[0].strip().replace('%','\%').replace('&','\&').replace('$','\$').replace('\r\n','\\newline ')
...
def generate_budget_rows(pid):
    ...
    if budget == []:
        print 'no budget'
        return '\\\\'
    result += temp.render(name='Total Sell',data=('\\textdollar'+' & \\textdollar  '.join(str(v) for v in budget['totalsell'])),total=('\\textdollar'+str(budget['sum_totalsell'])))
    result += temp.render(name='Total COGS',data=('\\textdollar'+' & \\textdollar'.join(str(v) for v in budget['totalcost'])),total=('\\textdollar'+str(budget['sum_totalcost'])))
    result += temp.render(name='Gross Profit',data=('\\textdollar'+' & \\textdollar'.join(str(v) for v in budget['totalgrossprofit'])),total=('\\textdollar'+str(budget['sum_totalgrossprofit'])))
    result += temp.render(name='Labour',data=('\\textdollar'+' & \\textdollar'.join(str(budget['labour']) for v in range(0,12))),total=('\\textdollar'+str(budget['labour']*12)))
    result += temp.render(name='Rent',data=('\\textdollar'+' & \\textdollar'.join(str(budget['rent']) for v in range(0,12))),total=('\\textdollar'+str(budget['rent']*12)))
    result += temp.render(name='Utility',data=('\\textdollar'+' & \\textdollar'.join(str(budget['utility']) for v in range(0,12))),total=('\\textdollar'+str(budget['utility']*12)))
    result += temp.render(name='Insurance',data=('\\textdollar'+' & \\textdollar'.join(str(budget['insurance']) for v in range(0,12))),total=('\\textdollar'+str(budget['insurance']*12)))
    result += temp.render(name='Merchant Fee',data=('\\textdollar'+' & \\textdollar'.join(str(v) for v in budget['merchant'])),total=('\\textdollar'+str(budget['sum_merchant'])))
    result += temp.render(name='Financing Expense',data=('\\textdollar'+' & \\textdollar'.join(str(budget['financing']) for v in range(0,12))),total=('\\textdollar'+str(budget['financing']*12)))
    result += temp.render(name='Subscription',data=('\\textdollar'+' & \\textdollar'.join(str(budget['subscription']) for v in range(0,12))),total=('\\textdollar'+str(budget['subscription']*12)))
    result += temp.render(name='Marketing',data=('\\textdollar'+' & \\textdollar'.join(str(budget['marketing']) for v in range(0,12))),total=('\\textdollar'+str(budget['marketing']*12)))
    result += temp.render(name='Professional Fee',data=('\\textdollar'+' & \\textdollar'.join(str(budget['pro']) for v in range(0,12))),total=('\\textdollar'+str(budget['pro']*12)))
    result += temp.render(name='Others',data=('\\textdollar'+' & \\textdollar'.join(str(v) for v in budget['other'])),total=('\\textdollar'+str(budget['sum_other'])))
    result += temp.render(name='Total Expenses',data=('\\textdollar'+' & \\textdollar'.join(str(v) for v in budget['totalexpenses'])),total=('\\textdollar'+str(budget['sum_totalexpenses'])))
    result += temp.render(name='Net Profit',data=('\\textdollar'+' & \\textdollar'.join(str(v) for v in budget['net_profit'])),total=('\\textdollar'+str(budget['sum_netprofit'])))
    return result
